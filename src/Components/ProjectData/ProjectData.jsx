const Project1 = require('../../Assets/Images/Project1.png');
const QuizApp = require('../../Assets/Images/QuizApp.png');
const Ecomm = require('../../Assets/Images/Ecomm.png');
const Netflix = require('../../Assets/Images/Netflix.png'); 
